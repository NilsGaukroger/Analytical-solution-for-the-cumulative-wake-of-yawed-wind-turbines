# -*- coding: utf-8 -*-
"""
Created on Sat Aug 27 17:11:03 2022
...
def vel_disc(flowdata, x_t, y_t, z_t, yaw, D, n=128):
    ...
    vel_d = np.asarray([flowdata_rotor.U.mean(), 0, 0])
...
def turb_add(y, z, y1, z1, s, CT, y2, z2, D, sep_x, I0):
    '''
    ...
    if sep_x < 0.1: # because I_p tends to infinity as separation tends to zero
        ...
        I_p = 0.65 * a**0.83 * I0**0.03 * (sep_x/D)**(-0.32)
